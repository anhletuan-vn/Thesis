...
The technologies for IoT ID naming have been used including IPv6~\citep{Deering:2017} developed by IETF, Handle System~\footnote{www.handle.net}, RFID developed by AutoID, URIs, etc.
...
%The sensor networks have become the most essential component of IoT as they are the ~\citep{Atzori:2010, Al-Fuqaha:2015}. 


\subsection{Communication Technologies}

Communication is the backbone technology of the IoT that connects heterogeneous objects, devices together and to deliveries smart services. IoT devices are resource constrained devices such as wireless sensors, they using low power in the presence of lossy and noisy communication links.
This section provides the overview of communication technologies that enable the communication for the IoT.
