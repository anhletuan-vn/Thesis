...
\begin{table}[ht!]
    ...
    \cline{5-6}
     & & & & & & & 3G & LTE \\
    \hline                                     
    %\multicolumn{1}{|c|}{\multirow{2}{*}{Range}} & indoor & \multirow{2}{*}{\textless 0.2 m} & \multirow{2}{*}{1-300 m} & \textless 20 m & \multirow{2}{*}{NA} & \multirow{2}{*}{\textless 10km} & \multirow{2}{*}{\textgreater 5km} & \multirow{2}{*}{\textgreater 5km} \\
    %\cline{2-2}\cline{5-5}
